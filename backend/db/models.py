...
class Supermercado(Base):
    ...
    precios = relationship(
        "Precio",
        back_populates="supermercado_rel"
    )
...
class Precio(Base):
    ...
    promo_temporal = Column(
        Boolean,
        default=False
    )

    precio_minimo_30d = Column(
        Boolean,
        default=False
    )

    requiere_membresia = Column(
        Boolean,
        default=False
    )
